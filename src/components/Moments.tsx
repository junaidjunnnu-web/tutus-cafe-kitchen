    ...
    <>
      ...
      {loading ? (
        <div className="text-center py-4">
          ...
          <p className="text-gray-600 mt-2 text-sm">Loading moments...</p>
        </div>
      ) : moments.length === 0 ? (
        <div className="text-center py-4">
          <Heart className="w-12 h-12 text-gray-300 mx-auto mb-3" />
          <p className="text-gray-500 mb-3">Share your moments with us!</p>
          <button
        ...
        <>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            {moments.slice(0, 6).map((moment) => (
              <div key={moment.id} className="rounded-lg shadow-sm border border-gray-100 overflow-hidden bg-white">
                <img
                ...
                {moment.caption && (
                  <div className="p-2">
                    <p className="text-gray-700 text-xs line-clamp-2">"{moment.caption}"</p>
                  </div>
                )}
              </div>
            ))}
