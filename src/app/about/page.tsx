        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="rounded-xl shadow-sm border border-gray-100 p-8 mb-12" style={{ backgroundColor: '#F5E6D3' }}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative h-80 bg-gradient-to-br from-orange-100 to-red-100 rounded-lg flex items-center justify-center">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="relative h-96 bg-gradient-to-br from-orange-100 to-red-100 rounded-lg flex items-center justify-center">
                <div className="text-9xl">👨‍🍳</div>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Head Chef</h3>
                <p className="text-orange-600 font-medium mb-4">Master of Tandoor & North Indian Cuisine</p>
                <div className="space-y-4 text-gray-600">
                  <p>
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="relative h-64 bg-gradient-to-br from-orange-100 to-red-100 rounded-lg flex items-center justify-center">
